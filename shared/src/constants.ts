...
export const TRUCK_HP = 80;
export const TRUCK_SPEED = 300;
export const TRUCK_ROTATION_SPEED = 2.5;
export const TRUCK_CAPACITY = 4;
export const TRUCK_RADIUS = 45;
export const TANK_HP = 120;
export const TANK_SPEED = 200;
export const TANK_ROTATION_SPEED = 1.5;
export const TANK_RADIUS = 50;
export const TANK_CANNON_FIRE_RATE = 0.5;
